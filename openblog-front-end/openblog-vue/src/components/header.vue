				...
				<div class="headBox">
					<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
						...
						<el-submenu index="/Share">
							<template slot="title"><i class="fa fa-wa fa-archive"></i> Classification</template>
							<el-menu-item v-for="(item,index) in classListObj" :key="'class1'+index" :index="'/Share?classId='+item.id">{{item.name}}</el-menu-item>
						</el-submenu>
						<el-menu-item index="/Reward"><i class="fa fa-wa fa-cny"></i> Admire</el-menu-item>
						<el-menu-item index="/Friendslink"><i class="fa fa-wa fa-users"></i>Friend chain</el-menu-item>
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/headbg05.jpg)'}">
		...
		<div class="h-information">
			...
			<h2 class="h-description">
                        ...
                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"Hi, Oumuanode"}}
