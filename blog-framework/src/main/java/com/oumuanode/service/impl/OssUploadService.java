...
import com.oumuanode.service.UploadService;
import com.oumuanode.utils.PathUtils;
...
public class OssUploadService implements UploadService {
    ...
    private String uploadOss(MultipartFile imgFile, String filePath){
        //构造一个带指定 Region 对象的配置类 华南-广东 Region.region2()
        ...
        try {
            ...
            try {
                ...
                return "http://rrhz6ukga.hn-bkt.clouddn.com/"+key;
